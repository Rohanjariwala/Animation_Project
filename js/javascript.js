...
$(".second_list").click(function () {
  ...
  $(this).addClass("active");
  $(".second_menu_inner")
    .addClass("second_step_active")
    .removeClass("second_first_step");
  $(".second_hidden_wrapper").show();
  setTimeout(function () {
    $(".second_menu").addClass("scroll");
  }, 1000);
});
...
$(".second_hidden_wrapper").click(function () {
  ...
  $(".second_menu_inner")
    .removeClass("second_step_active")
    .addClass("second_first_step");
  $(".second_menu").removeClass("scroll");
  $(this).hide();
});
// second step
